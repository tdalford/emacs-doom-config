;;; my-doom-one-light-theme.el --- inspired by Atom One Light -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme my-doom-one-light
  ...
  ;; change bg from fafafa to white, fg from 383a42 to black
  ;; name        default   256       16
  ((bg         '("white" "white"   "white"        ))
   (fg         '("black" "#424242" "black"        ))
  ...
  (
   ;; ((font-lock-comment-face &override) ;; why the hell is this on
